...
/*   Updated: 2020/07/22 00:55:52 by white            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_putnbr(long long int n, t_param *f_param)
{
	...
	while (++i <= 19)
		f_param->len += write(1, numbers + i, 1);
}

void	ft_unsigned_putnbr(unsigned long long int n, t_param *f_param)
{
	size_t	i;
	char	numbers[20];
